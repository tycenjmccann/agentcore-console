      ...
      <div className="space-y-6">
        ...
        <fieldset className="space-y-4">
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-3 py-2.5 bg-[var(--color-surface-2)] border border-[var(--color-border)] rounded-lg text-[var(--color-text-primary)] placeholder-[var(--color-text-muted)] focus:outline-none focus:border-brand-500 focus:ring-1 focus:ring-brand-500/20 transition-colors"
              required
            />
          </div>
          ...
          <div>
            ...
            <textarea
              ...
              rows={6}
              className="w-full px-3 py-2.5 bg-[var(--color-surface-2)] border border-[var(--color-border)] rounded-lg text-[var(--color-text-primary)] placeholder-[var(--color-text-muted)] focus:outline-none focus:border-brand-500 focus:ring-1 focus:ring-brand-500/20 resize-y transition-colors"
            />
          </div>
        </fieldset>
        ...
        <fieldset className="space-y-3">
          ...
          <div className="flex gap-2">
            <input
              ...
              className="flex-1 px-3 py-2 bg-[var(--color-surface-2)] border border-[var(--color-border)] rounded-lg text-[var(--color-text-primary)] placeholder-[var(--color-text-muted)] text-sm focus:outline-none focus:border-brand-500 focus:ring-1 focus:ring-brand-500/20 transition-colors"
              onKeyDown={(e) =>
        ...
        <fieldset className="space-y-3">
          ...
          <div className="flex gap-2">
            ...
            <input
              ...
              placeholder="main"
              className="w-24 px-3 py-2 bg-[var(--color-surface-2)] border border-[var(--color-border)] rounded-lg text-[var(--color-text-primary)] placeholder-[var(--color-text-muted)] text-sm focus:outline-none focus:border-brand-500 focus:ring-1 focus:ring-brand-500/20 transition-colors"
            />
          </div>
        </fieldset>
            ...
            {modelsLoading ? (
              ...
              <>
                <select
                  ...
                  className="w-full px-3 py-2.5 bg-[var(--color-surface-2)] border border-[var(--color-border)] rounded-lg text-[var(--color-text-primary)] focus:outline-none focus:border-brand-500 focus:ring-1 focus:ring-brand-500/20 cursor-pointer appearance-none transition-colors"
                  style={{
        ...
        <div className="pt-2">
          <button
            ...
            className="w-full px-4 py-3 bg-brand-600 text-white font-semibold rounded-lg hover:bg-brand-500 disabled:opacity-50 disabled:cursor-not-allowed transition-all shadow-lg shadow-brand-600/20 hover:shadow-brand-500/30"
          >
            {isLoading ? (
