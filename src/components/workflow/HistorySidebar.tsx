...
const LS_KEY_COLLAPSED = "agentis_sidebar_collapsed";
const LS_KEY_WIDTH = "agentis_sidebar_width";
...
export default function HistorySidebar({
  ...
  return (
    <div
      ref={sidebarRef}
      className={cn(
        "relative flex flex-col flex-shrink-0 border-r border-[var(--color-border)] bg-[var(--color-surface-1)] h-full",
          ...
          <div className="p-4 border-b border-[var(--color-border)]">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-8 pr-3 py-1.5 bg-[var(--color-surface-2)] border border-[var(--color-border)] rounded-md text-xs text-[var(--color-text-primary)] placeholder-[var(--color-text-muted)] focus:outline-none focus:border-brand-500 focus:ring-1 focus:ring-brand-500/20 transition-colors"
